...
-- CONFIGURAÇÃO PADRÃO DE AUTO INCRMENTO
	ALTER TABLE alunos MODIFY id INT NOT NULL AUTO_INCREMENT;

-- INSERIDNO UM REGISTRO UTILIZANOD O RECURSO AUTO INCREMENTO
	INSERT INTO alunos (nome, ra) VALUES("Stephani", "12345");